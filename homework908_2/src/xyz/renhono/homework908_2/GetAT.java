	...
	protected List<Map<String, String>> doInBackground(String... params) {
		...
		try {
			...
			if (conn.getResponseCode() == 200) {
				...
				map.put("ip", jdata.optString("ip"));
				map.put("ip_str", jdata.optString("ip_str"));
				map.put("ip_end", jdata.optString("ip_end"));
				map.put("inet_str", jdata.optString("inet_str"));
				map.put("inet_end", jdata.optString("inet_end"));
				map.put("operators", jdata.optString("operators"));
				map.put("att", jdata.optString("att"));
				map.put("detailed", jdata.optString("detailed"));
				map.put("area_style_simcall", jdata.optString("area_style_simcall"));
				map.put("area_style_areanm", jdata.optString("area_style_areanm"));
