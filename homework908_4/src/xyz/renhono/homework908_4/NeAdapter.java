...
public class NeAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv2.setText(map.get("par"));
		holder.tv3.setText(map.get("idcard"));
		holder.tv4.setText(map.get("born"));
		holder.tv5.setText(map.get("sex"));
		holder.tv6.setText(map.get("att"));
		holder.tv7.setText(map.get("postno"));
		holder.tv8.setText(map.get("areano"));
		holder.tv9.setText(map.get("style_simcall"));
		holder.tv10.setText(map.get("style_citynm"));
