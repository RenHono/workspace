...
public class NeAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv3.setText(map.get("area"));
		holder.tv4.setText(map.get("postno"));
		holder.tv5.setText(map.get("att"));
		holder.tv6.setText(map.get("ctype"));
		holder.tv7.setText(map.get("par"));
		holder.tv8.setText(map.get("prefix"));
		holder.tv9.setText(map.get("operators"));
		holder.tv10.setText(map.get("style_simcall"));
		holder.tv11.setText(map.get("style_citynm"));
